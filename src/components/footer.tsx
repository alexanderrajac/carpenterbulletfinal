        ...
        <div className="mb-6 md:mb-0">
          <div className="flex items-center gap-2">
            <img
              ...
              className="h-8 w-8 rounded-lg object-cover bg-muted border border-border/40 shadow-sm"
            />
        ...
        <div className="mt-6 md:mt-8 md:grid md:grid-cols-4 md:gap-8">
          ...
          <FooterAccordion title="03. Blogs & Local SEO">
            <ul className="space-y-2.5 text-sm text-muted-foreground">
              ...
              <li>
                <Link to="/carpenters/chennai/ambattur/door" className="font-semibold text-amber-600 dark:text-amber-400 hover:underline">
                  📍 Tamil Nadu Local SEO Hub →
                </Link>
              </li>
              <li>
