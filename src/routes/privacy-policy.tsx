  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <article className="prose prose-zinc dark:prose-invert max-w-none space-y-6">
        <h1 className="font-display text-4xl font-semibold tracking-tight sm:text-5xl border-b border-border pb-4">Privacy Policy</h1>
        ...
        <section className="space-y-3 pt-4">
          ...
          <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-1">
            ...
            <li><strong>Order Data:</strong> Shipping address, billing address, phone number, and UPI UTR details for payment verification.</li>
            <li><strong>Analytics Data:</strong> IP address, browser type, and navigation activity to improve site performance.</li>
          </ul>
        </section>

        <section className="space-y-3 pt-4 border-t border-border">
          <h2 className="font-display text-2xl font-semibold text-foreground">2. How We Use Your Data</h2>
          <p className="text-muted-foreground text-sm leading-relaxed">
            Your information is used strictly to craft and deliver your orders and manage your account:
          </p>
          <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-1">
            <li>To verify payments (matching UPI Transaction Ref/UTR details to complete checkout).</li>
        ...
        <section className="space-y-3 pt-4 border-t border-border">
          ...
          <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-1">
            ...
            <li><strong>Delivery Partners:</strong> Local and national freight carriers to ship heavy furniture to your address.</li>
          </ul>
        </section>

        <section className="space-y-3 pt-4 border-t border-border">
          <h2 className="font-display text-2xl font-semibold text-foreground">4. Security of Your Data</h2>
          <p className="text-muted-foreground text-sm leading-relaxed">
            We store passwords securely using industry-standard hashing protocols provided by Supabase. Although no digital storage is 100% secure, we implement state-of-the-art security guidelines to protect your personal details against unauthorized access.
          </p>
        </section>
