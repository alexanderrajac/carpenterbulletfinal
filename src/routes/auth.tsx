...
export const Route = createFileRoute("/auth")({
  ...
  head: () => ({ meta: [{ title: "Sign in — CarpenterBullet" }] }),
  component: AuthPage,
});
...
function AuthPage() {
  ...
  const fieldCls =
    "w-full rounded-xl border border-border bg-card px-4 py-2.5 text-sm outline-none focus:border-primary transition-colors";
    ...
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-4 py-12 sm:px-6">
      <div className="rounded-3xl border border-border bg-card p-8 shadow-sm">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          {mode === "signin" ? "Sign in to your CarpenterBullet account." : "Join the workshop."}
        </p>

        <button
          onClick={google}
          disabled={loading}
          className="mt-6 flex w-full items-center justify-center gap-2 rounded-full border border-border bg-background py-2.5 text-sm font-medium hover:bg-accent disabled:opacity-60 cursor-pointer transition-colors"
        >
