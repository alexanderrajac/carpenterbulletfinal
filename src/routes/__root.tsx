...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "CarpenterBullet — The Amazon + IKEA + Urban Company of the Wood Industry" },
      { property: "og:description", content: "Order raw wood, custom furniture, hardware, and book top-rated carpenter services." },
    ],
    links: [
