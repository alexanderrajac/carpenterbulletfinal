      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Manage department categories for your storefront.
          </p>
        </div>
        <button
          onClick={openNew}
                ...
                <div className="flex gap-1 shrink-0">
                  ...
                  <button
                    onClick={() => {
                      if (
                        confirm(
                          "Delete this category? Products using it will become uncategorized.",
                        )
                      )
              ...
              <div className="space-y-1.5 p-3.5 rounded-2xl border border-dashed border-border bg-muted/20">
                ...
                <div className="flex items-center gap-4 mt-1">
                  <img
                    ...
                    alt=""
                    className="h-14 w-14 rounded-xl object-cover bg-card border border-border/40 shrink-0"
                  />
